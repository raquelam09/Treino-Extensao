...
# Padronizar SEXO_PROPRIETARIO
dados_bd2$SEXO_PROPRIETARIO <- ifelse(
  dados_bd2$SEXO_PROPRIETARIO == "M",
  "Masculino",
  "Feminino"
)
...
table(dados_bd2$SEXO_PROPRIETARIO)
table(dados_bd2$TIPO_VEICULO)
